...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Follows',
            fields=[
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='user.Users')),
            ],
            options={
                'db_table': 'follows',
                'managed': False,
        ...
        migrations.CreateModel(
            name='GoingTo',
            fields=[
                ('user', models.ForeignKey(db_column='User_id', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='user.Users')),
            ],
            options={
                'db_table': 'going_to',
                'managed': False,
        ...
        migrations.CreateModel(
            name='TripPhotos',
            fields=[
                ('trip', models.ForeignKey(db_column='Trip_id', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='user.Trips')),
